...
set multiplot
  set origin 0.14,0.13 #MOVING OF THE ORIGIN TO FIT THE AXIS LABELS
  set size   0.82,0.75 #SIZE OF THE FIGURE IN THE TOTAL IMAGE (MAX IS 1.0 X 1.0)
    set title "Total number of cases over time"
    ...
    stats 'total_cases.dat' name 'a'
    plot [a_min_x:a_max_x] 'total_cases.dat' w l lw 3.0 lc "red"
